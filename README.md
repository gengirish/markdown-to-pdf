...
| `DODO_PRODUCT_PRO` / `_SCALE` | For billing | The Dodo product id each paid tier is sold as. These differ between test and live mode. A tier whose variable is unset cannot be bought (checkout answers 503) |
