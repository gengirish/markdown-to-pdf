#!/usr/bin/env python3
"""Minimal PDF Cert Generator flow: list courses, issue, verify, download PDF.

Requires: pip install httpx
Env: PDFCERT_URL (default http://localhost:8000), PDFCERT_API_KEY (if server enforces keys).
"""
